  ...
  render() {
    return (
      <div>
        ...
        <div className="part4">
          <List renderHeader={() => <div>预订人姓名(必填)</div>}>
            <InputItem
              type="text"
            ...
            ><span className='renderHeader'>*</span>姓名</InputItem>
          </List>
          ...
          <List renderHeader={() => <div>预定人手机号码/电话(必填)</div>}>
            <InputItem
              type="number"
            ...
            ><span className='renderHeader'>*</span>手机电话</InputItem>
          </List>
          <List renderHeader={() =>  <div>预定人邮箱(必填)</div>}>
            <InputItem
              type="text"
            ...
            ><span className='renderHeader'>*</span>邮箱</InputItem>
          </List>
        </div>
