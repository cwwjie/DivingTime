...
class room extends React.Component {
  ...
  componentDidMount() {
    ...
    if (this.props.infor.loaddata.template == 1) {
      _date.bedTypeList = [
        { label: '大床', value: '大床' },
        { label: '大床(仅园景房提供)', value: '大床(仅园景房提供)' },
        { label: '蜜月大床(需半年内结婚证申请/含免费花瓣铺床，烛光晚餐)', value: '蜜月大床' },
        { label: '大床+单床', value: '大床+单床' },
        { label: '双床+单床', value: '双床+单床' },
      ];
    }else if (this.props.infor.loaddata.template == 2) {
      _date.bedTypeList = [
        { label: '大床', value: '大床' },
        { label: '双床', value: '双床' },
        { label: '大床+单床(联排不可选)', value: '大床+单床' },
        { label: '双床+单床(联排不可选)', value: '双床+单床' },
        { label: '大床+床垫(只限联排房间)', value: '大床+床垫' },
        { label: '双床+床垫(只限联排房间)', value: '双床+床垫' },
        { label: '蜜月大床(需半年内结婚证申请/含免费花瓣铺床)', value: '蜜月大床' },
      ];
    }else if (this.props.infor.loaddata.template == 3) {
      _date.bedTypeList = [
        { label: '单床(一人入住只能选)', value: '单床' },
        { label: '大床', value: '大床' },
        { label: '双床', value: '双床' },
        { label: '大床+单床', value: '大床+单床' },
        { label: '双床+单床', value: '双床+单床' },
        { label: '蜜月大床(需要支付160马币/仅限入住当天)', value: '蜜月大床' },
      ];
    }else if (this.props.infor.loaddata.template == 4) {
      _date.bedTypeList = [
        { label: '单床(仅限四人间选)', value: '单床' },
        { label: '双床(二人间可选)', value: '双床' },
        { label: '大床(二人间可选)', value: '大床' },
      ];
      ...
      _date.bedTypeList = [
        ...
        { label: '大床+单床', value: '大床+单床' },
        { label: '双床+单床', value: '双床+单床' },
        { label: '大床+床垫', value: '大床+床垫' },
        { label: '双床+床垫', value: '双床+床垫' },
        { label: '蜜月大床(需半年内结婚证申请/含免费花瓣铺床)', value: '蜜月大床' },
      ];
