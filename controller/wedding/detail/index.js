...
module.exports = async (ctx, next) => {
  ...
  const WriteJavaScriptFilePath = RelativeToFilePath('./static/wedding/detail/');
  ...
  const WriteCSSfilePath = RelativeToFilePath('./static/wedding/detail');
  ...
  const WriteHTMLfilePath = RelativeToFilePath('./static/wedding/detail/index.html');
