...
module.exports = async (ctx, next) => {
  ...
  const WriteJavaScriptFilePath = RelativeToFilePath('./static/wedding/');
  ...
  const WriteCSSfilePath = RelativeToFilePath('./static/wedding');
  ...
  const WriteHTMLfilePath = RelativeToFilePath('./static/wedding/index.html');
